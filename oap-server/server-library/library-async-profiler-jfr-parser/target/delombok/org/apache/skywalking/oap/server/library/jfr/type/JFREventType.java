...
public enum JFREventType {
    UNKNOWN(-1), EXECUTION_SAMPLE(1), JAVA_MONITOR_ENTER(2), THREAD_PARK(3), OBJECT_ALLOCATION_IN_NEW_TLAB(4), OBJECT_ALLOCATION_OUTSIDE_TLAB(5), PROFILER_LIVE_OBJECT(6), 
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    private JFREventType(final int code) {
        this.code = code;
    }
}
