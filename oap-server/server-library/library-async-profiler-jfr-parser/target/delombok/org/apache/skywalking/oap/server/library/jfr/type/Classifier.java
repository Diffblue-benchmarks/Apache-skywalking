// Generated by delombok at Fri May 16 09:04:10 BST 2025
/*
...
public abstract class Classifier {
    ...
    public Category getCategory(StackTrace stackTrace) {
        ...
        Category category;
        if ((category = detectGcJit(methods, types)) == null && (category = detectClassLoading(methods, types)) == null) {
    ...
    private Category detectClassLoading(long[] methods, byte[] types) {
        for (int i = 0; i < methods.length; i++) {
            ...
            } else if (methodName.startsWith("LinkResolver::") || methodName.startsWith("InterpreterRuntime::resolve") || methodName.startsWith("SystemDictionary::resolve")) {
                return Category.CLASS_RESOLVE;
            } else if (methodName.endsWith("ClassLoader.loadClass")) {
                return Category.CLASS_LOAD;
            } else if (methodName.endsWith("LambdaMetafactory.metafactory") || methodName.endsWith("LambdaMetafactory.altMetafactory")) {
