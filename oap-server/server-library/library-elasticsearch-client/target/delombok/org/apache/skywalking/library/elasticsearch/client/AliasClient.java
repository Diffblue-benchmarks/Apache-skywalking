...
public final class AliasClient {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AliasClient.class);
    private final CompletableFuture<ElasticSearchVersion> version;
    private final WebClient client;

    public Map<String, Index> indices(String name) {
        try {
            final CompletableFuture<Map<String, Index>> future = version.thenCompose(v -> client.execute(v.requestFactory().alias().indices(name)).aggregate().thenApply(response -> {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public AliasClient(final CompletableFuture<ElasticSearchVersion> version, final WebClient client) {
