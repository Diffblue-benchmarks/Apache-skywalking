...
public final class IdsQuery extends Query {
    ...
    static class Serializer extends JsonSerializer<IdsQuery> {
        @Override
        public void serialize(final IdsQuery value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    IdsQuery(final ImmutableList<String> ids) {
        this.ids = ids;
    }
}
