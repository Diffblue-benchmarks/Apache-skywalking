...
public final class MaxAggregation extends Aggregation {
    ...
    static final class Serializer extends JsonSerializer<MaxAggregation> {
        @Override
        public void serialize(final MaxAggregation value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    MaxAggregation(final String name, final String field) {
        this.name = name;
        this.field = field;
    }
}
