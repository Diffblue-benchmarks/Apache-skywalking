...
public final class BoolQuery extends Query {
    ...
    static final class BoolQuerySerializer extends JsonSerializer<BoolQuery> {
        ...
        @Override
        public void serialize(final BoolQuery value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
        ...
        private void writeArray(final JsonGenerator gen, final String name, final List<Query> array) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    BoolQuery(final ImmutableList<Query> must, final ImmutableList<Query> mustNot, final ImmutableList<Query> should, final ImmutableList<Query> shouldNot) {
        this.must = must;
