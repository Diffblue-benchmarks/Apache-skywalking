...
final class V7TemplateFactory implements TemplateFactory {
    ...
    public HttpRequest createOrUpdate(String name, Map<String, ?> settings, Mappings mappings, int order) {
        try {
            ...
            final Map<String, Object> template = ImmutableMap.<String, Object>builder().put("index_patterns", patterns).put("aliases", aliases).put("settings", settings).put("mappings", mappings).build();
    ...
    @lombok.Generated
    public V7TemplateFactory(final ElasticSearchVersion version) {
