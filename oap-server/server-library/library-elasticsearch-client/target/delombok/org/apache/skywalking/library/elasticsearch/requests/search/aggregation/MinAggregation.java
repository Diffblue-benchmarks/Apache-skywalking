...
public final class MinAggregation extends Aggregation {
    ...
    static final class Serializer extends JsonSerializer<MinAggregation> {
        @Override
        public void serialize(final MinAggregation value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    MinAggregation(final String name, final String field) {
        this.name = name;
        this.field = field;
    }
}
