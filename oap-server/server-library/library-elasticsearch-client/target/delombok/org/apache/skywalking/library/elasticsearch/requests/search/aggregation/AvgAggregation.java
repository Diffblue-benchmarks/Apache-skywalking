...
public final class AvgAggregation extends Aggregation {
    ...
    static final class Serializer extends JsonSerializer<AvgAggregation> {
        @Override
        public void serialize(final AvgAggregation value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    AvgAggregation(final String name, final String field) {
        this.name = name;
        this.field = field;
    }
}
