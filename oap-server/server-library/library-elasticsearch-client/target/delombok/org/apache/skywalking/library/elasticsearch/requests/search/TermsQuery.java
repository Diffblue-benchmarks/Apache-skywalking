...
public final class TermsQuery extends Query {
    ...
    static final class Serializer extends JsonSerializer<TermsQuery> {
        ...
        @Override
        public void serialize(final TermsQuery term, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    TermsQuery(final String name, final List<?> values) {
        this.name = name;
        this.values = values;
    }
}
