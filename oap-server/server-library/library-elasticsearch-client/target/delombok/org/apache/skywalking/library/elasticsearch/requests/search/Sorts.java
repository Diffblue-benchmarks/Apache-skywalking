...
final class Sorts implements Iterable<Sort> {
    ...
    static class Serializer extends JsonSerializer<Sorts> {
        @Override
        public void serialize(final Sorts value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
            gen.writeStartArray();
            {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    Sorts(final ImmutableList<Sort> sorts) {
        this.sorts = sorts;
    }
}
