...
public final class TermQuery extends Query {
    ...
    static final class Serializer extends JsonSerializer<TermQuery> {
        ...
        @Override
        public void serialize(final TermQuery term, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    TermQuery(final String name, final Object value) {
        this.name = name;
        this.value = value;
    }
}
