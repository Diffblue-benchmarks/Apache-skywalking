...
public final class BulkProcessorBuilder {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BulkProcessorBuilder.class);
    ...
    public BulkProcessor build(AtomicReference<ElasticSearch> es) {
        return new BulkProcessor(es, bulkActions, flushInterval, concurrentRequests, batchOfBytes);
    }
