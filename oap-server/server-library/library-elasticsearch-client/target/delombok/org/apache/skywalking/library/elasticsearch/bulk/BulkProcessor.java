...
public final class BulkProcessor {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(BulkProcessor.class);
    ...
    BulkProcessor(final AtomicReference<ElasticSearch> es, final int bulkActions, final Duration flushInterval, final int concurrentRequests, final int batchOfBytes) {
        ...
        scheduler.scheduleWithFixedDelay(new RunnableWithExceptionProtection(this::doPeriodicalFlush, t -> log.error("flush data to ES failure:", t)), 0, flushInterval.getSeconds(), TimeUnit.SECONDS);
    }
    ...
    static class Holder {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public Holder(final CompletableFuture<Void> future, final Object request) {
            this.future = future;
