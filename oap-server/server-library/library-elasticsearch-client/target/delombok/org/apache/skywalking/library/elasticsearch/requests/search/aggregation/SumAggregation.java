...
public final class SumAggregation extends Aggregation {
    ...
    static final class Serializer extends JsonSerializer<SumAggregation> {
        @Override
        public void serialize(final SumAggregation value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    SumAggregation(final String name, final String field) {
        this.name = name;
        this.field = field;
    }
}
