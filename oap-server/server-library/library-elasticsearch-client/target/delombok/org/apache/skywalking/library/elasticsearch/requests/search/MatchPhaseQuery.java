...
public final class MatchPhaseQuery extends Query {
    ...
    static class Serializer extends JsonSerializer<MatchPhaseQuery> {
        @Override
        public void serialize(final MatchPhaseQuery value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    MatchPhaseQuery(final String name, final String text) {
        this.name = name;
        this.text = text;
    }
}
