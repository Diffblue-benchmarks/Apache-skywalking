...
final class V7DocumentFactory implements DocumentFactory {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(V7DocumentFactory.class);
    ...
    public HttpRequest exist(String index, String type, String id) {
        ...
        return HttpRequest.builder().head("/{index}/_doc/{id}").pathParam("index", index).pathParam("id", id).build();
    }
    ...
    public HttpRequest get(String index, String type, String id) {
        ...
        checkArgument(!isNullOrEmpty(type), "type cannot be null or empty");
        checkArgument(!isNullOrEmpty(id), "id cannot be null or empty");
        return HttpRequest.builder().get("/{index}/_doc/{id}").pathParam("index", index).pathParam("id", id).build();
    }
    ...
    public HttpRequest mget(String index, String type, Iterable<String> ids) {
        try {
            ...
            return HttpRequest.builder().get("/{index}/_doc/_mget").pathParam("index", index).content(MediaType.JSON, content).build();
    ...
    public HttpRequest index(IndexRequest request, Map<String, ?> params) {
        try {
            ...
            builder.put("/{index}/_doc/{id}").pathParam("index", index).pathParam("id", id).content(MediaType.JSON, content);
    ...
    public HttpRequest update(UpdateRequest request, Map<String, ?> params) {
        try {
            ...
            builder.post("/{index}/_doc/{id}/_update").pathParam("index", index).pathParam("id", id).content(MediaType.JSON, content);
            return builder.build();
        } catch (final java.lang.Throwable $ex) {
            throw lombok.Lombok.sneakyThrow($ex);
        }
    ...
    public HttpRequest delete(String index, String type, Query query, Map<String, ?> params) {
        try {
            ...
            return builder.delete("/{index}/_doc/_delete_by_query").pathParam("index", index).content(MediaType.JSON, content).build();
        } catch (final java.lang.Throwable $ex) {
            throw lombok.Lombok.sneakyThrow($ex);
        }
    }
    ...
    public HttpRequest deleteById(final String index, final String type, final String id, Map<String, ?> params) {
        ...
        return builder.delete("/{index}/_doc/{id}").pathParam("index", index).pathParam("id", id).build();
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public V7DocumentFactory(final ElasticSearchVersion version) {
