...
public class YamlConfigLoaderUtils {
    ...
    @lombok.Generated
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(YamlConfigLoaderUtils.class);

    public static void replacePropertyAndLog(final String propertyName, final Object propertyValue, final Properties target, final Object providerName, final Yaml yaml) {
        final String valueString = PropertyPlaceholderHelper.INSTANCE.replacePlaceholders(String.valueOf(propertyValue), target);
    ...
    public static void copyProperties(final Object dest, final Properties src, final String moduleName, final String providerName) throws IllegalAccessException {
        if (dest == null) {
            return;
        }
