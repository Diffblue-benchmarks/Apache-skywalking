...
public class Gauge extends Metric {
    ...
    public static class GaugeBuilder {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public Gauge.GaugeBuilder name(final String name) {
            this.name = name;
            return this;
        }
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public Gauge.GaugeBuilder label(final String labelKey, final String labelValue) {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public Gauge.GaugeBuilder labels(final java.util.Map<? extends String, ? extends String> labels) {
            if (labels == null) {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public Gauge.GaugeBuilder clearLabels() {
            if (this.labels$key != null) {
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public Gauge.GaugeBuilder value(final double value) {
            this.value = value;
            return this;
        }
        ...
        @java.lang.SuppressWarnings("all")
        @lombok.Generated
        public Gauge.GaugeBuilder timestamp(final long timestamp) {
        ...
        public java.lang.String toString() {
            return "Gauge.GaugeBuilder(name=" + this.name + ", labels$key=" + this.labels$key + ", labels$value=" + this.labels$value + ", value=" + this.value + ", timestamp=" + this.timestamp + ")";
        }
    }

    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public static Gauge.GaugeBuilder builder() {
        return new Gauge.GaugeBuilder();
    }
